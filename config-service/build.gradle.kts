...
dependencies {
  ...
  implementation(projects.notificationConfigServiceImpl)
  ...
  constraints {
    runtimeOnly("io.netty:netty-codec-http2:4.1.66.Final") {
      because("Multiple Vulnerabilities")
    }
    runtimeOnly("io.netty:netty-handler-proxy:4.1.66.Final") {
      because("Multiple Vulnerabilities")
    }
  }
